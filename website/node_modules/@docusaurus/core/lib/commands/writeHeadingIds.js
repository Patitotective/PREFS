...
async function getPathsToWatch(siteDir) {
    ...
    return (0, lodash_1.flatten)(plugins.map((plugin) => { var _a, _b; return (_b = (_a = plugin === null || plugin === void 0 ? void 0 : plugin.getPathsToWatch) === null || _a === void 0 ? void 0 : _a.call(plugin)) !== null && _b !== void 0 ? _b : []; }));
}
async function writeHeadingIds(siteDir) {
    const markdownFiles = await (0, utils_2.safeGlobby)(await getPathsToWatch(siteDir), {
