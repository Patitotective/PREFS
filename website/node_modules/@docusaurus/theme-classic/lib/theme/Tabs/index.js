...
function TabsComponent(props) {
  var _ref, _children$find, _children$;
  ...
  const children = _react.Children.map(props.children, child => {
  ...
  const values = valuesProp !== null && valuesProp !== void 0 ? valuesProp : children.map(({
    props: {
      value,
      label
    }
  ...
  const defaultValue = defaultValueProp === null ? defaultValueProp : (_ref = defaultValueProp !== null && defaultValueProp !== void 0 ? defaultValueProp : (_children$find = children.find(child => child.props.default)) === null || _children$find === void 0 ? void 0 : _children$find.props.value) !== null && _ref !== void 0 ? _ref : (_children$ = children[0]) === null || _children$ === void 0 ? void 0 : _children$.props.value;
